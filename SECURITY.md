...
| SQL injection in the vector store | CWE-89 | Not applicable — ChromaDB is accessed exclusively via its Python API (parameterized calls). No raw SQL is constructed anywhere in `mcp_server/`. | — |
